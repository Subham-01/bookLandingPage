    ...
    return (
        <section className="body-font px-4 lg:px-20 ">
            <div className="container mx-auto flex py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 relative  flex flex-col md:items-start md:text-left mb-16 md:mb-0  ">
                    ...
                    <p className="text-base lg:text-lg font-semibold text-gray-300 mt-2  mb-8 w-full ">
