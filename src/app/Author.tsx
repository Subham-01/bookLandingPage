    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0  lg:ml-8 mt-10 lg:mt-0">
                    <p className='text-dimText border-b-2 border-primary w-full capitalize pb-1'>
                        AUTHOR
                    </p>
                    <h1 className="sm:text-6xl mt-6 text-left text-3xl mb-4 font-medium text-white ">
                        SECRET OF<br />
                        MANHATTAN
                    ...
                    <p className="text-lg font-semibold text-gray-300 mt-2  mb-8 w-full ">
